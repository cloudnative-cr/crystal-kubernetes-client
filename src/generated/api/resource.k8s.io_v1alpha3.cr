...
module Kubernetes
  class Client
    ...
    def delete_collection_device_taint_rule(**params, &)
    ...
    def list_device_taint_rule(**params, &)
      path = "/apis/resource.k8s.io/v1alpha3/devicetaintrules"
      get(path) { |res| yield res }
    end
    ...
    def create_device_taint_rule(**params, &)
      path = "/apis/resource.k8s.io/v1alpha3/devicetaintrules"
    ...
    def delete_device_taint_rule(**params, &)
    ...
    def read_device_taint_rule(**params, &)
      path = "/apis/resource.k8s.io/v1alpha3/devicetaintrules/{name}"
      params.each { |k, v| path = path.gsub("{#{k}}", v.to_s) }
      get(path) { |res| yield res }
    end
    ...
    def patch_device_taint_rule(**params, &)
      path = "/apis/resource.k8s.io/v1alpha3/devicetaintrules/{name}"
      params.each { |k, v| path = path.gsub("{#{k}}", v.to_s) }
    ...
    def replace_device_taint_rule(**params, &)
      path = "/apis/resource.k8s.io/v1alpha3/devicetaintrules/{name}"
      params.each { |k, v| path = path.gsub("{#{k}}", v.to_s) }
