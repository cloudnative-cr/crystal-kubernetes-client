...
module Kubernetes
  ...
  struct StorageVersion
    ...
    property spec : Hash(String, JSON::Any)?
  ...
  struct PodCertificateRequestSpec
    ...
    @[JSON::Field(key: "pkixPublicKey")]
    @[YAML::Field(key: "pkixPublicKey")]
    property pkix_public_key : String?
    ...
    @[JSON::Field(key: "proofOfPossession")]
    @[YAML::Field(key: "proofOfPossession")]
    property proof_of_possession : String?
  ...
  struct StorageVersionMigrationSpec
    ...
    @[JSON::Field(key: "continueToken")]
    @[YAML::Field(key: "continueToken")]
    property continue_token : String?
    # The resource that is being migrated. The migrator sends requests to the endpoint serving the resource. Immutable.
    property resource : GroupVersionResource?
  end
  ...
  struct StorageVersionMigrationStatus
    ...
    property conditions : Array(MigrationCondition)?
